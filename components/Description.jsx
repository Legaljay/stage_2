...
const Description = () => {
  return (
    <p className="text-gray-600 text-lg font-inter font-medium capitalize leading-7 tracking-wide break-words">
      ...
      can kiss those stubborn food residues goodbye. Perfect for whipping up
      your favorite dishes, this set combines style and functionality in one
      size that fits all your cooking needs. Upgrade your kitchen today with the
      Blue Cookware Set!
    </p>
  );
};
